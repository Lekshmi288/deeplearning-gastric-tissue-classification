...
- Building an interactive Streamlit app (```PathoPredictX-GC```) to audit model predictions and visualize Grad-CAM heatmaps, helping bridge the gap between AI-based histology models and expert review in high-stakes domains like cancer diagnosis.
